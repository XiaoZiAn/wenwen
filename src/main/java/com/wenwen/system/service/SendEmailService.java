...
public class SendEmailService {
    ...
    // 发件人邮箱
    private static String myEmailAccount = "1051337247@qq.com";

    // 发件人邮箱密码（授权码）
    // 在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "jhlkuqjlwipjbeag";
    ...
    public void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception {
        ...
        // 写入我的官网
        builder.append("\n come from : https://www.wenwen.com");
        ...
        msg.setFrom(new InternetAddress(myEmailAccount, "零零玖", "UTF-8"));
